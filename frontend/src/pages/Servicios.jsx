...
function CategoriaSection({ categoria, globalIndex }) {
  return (
    ...
    >
      ...
      {/* Aclaración siempre visible (si la hay) */}
      {categoria.aclaracion && (
        <div
          className="flex gap-3 mb-6 p-4 rounded-xl text-sm leading-relaxed"
          style={{
        ...
        >
          <Info size={15} className="shrink-0 mt-0.5" style={{ color: 'rgba(192,132,252,0.7)' }} />
